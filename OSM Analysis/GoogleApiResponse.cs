...
namespace OSM_Analysis
{
    ...
    class GoogleApiResponse
    {
        ...
        public List<Coordinates> GetGoogleCoordinates()
        {
            ...
            foreach (Itineraryitem leg in routeLegs.itineraryItems)
            {
                Coordinates c = new Coordinates(leg.maneuverPoint.coordinates, 1);
                allCoordinates.Add(c);
            }

            Coordinates end = new Coordinates(routeLegs.actualEnd.coordinates, 1);
